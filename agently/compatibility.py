...
_CURRENT_RELEASE_MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'notes': 'Version-scoped companion compatibility manifest for Agently 4.1.4.7. This patch requires Agently-Stage '
          '0.3.6 so mixed sync/async boundaries automatically select a physically safe Stage carrier while preserving '
          'TriggerFlow ownership, settlement, and public state semantics.',
 'runtime_support': {'agently_stage': {'version_specifier': '>=0.3.6,<0.4.0',
